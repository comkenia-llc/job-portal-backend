...
const maskEmail = (email = "") => {
    ...
    if (!name || !domain) return value || "Not provided";
...
function emailChangedTemplate({
    ...
    const safeOldEmail = escapeHtml(maskEmail(oldEmail));
    const safeNewEmail = escapeHtml(maskEmail(newEmail));
    ...
    const subject = "Your Dubai Job Zone email address was changed";

    const text = `
Hi ${name},

The email address on your Dubai Job Zone account was changed.

Previous email: ${maskEmail(oldEmail)}
...
You can also contact us at ${supportEmail}.
          ...
          <tr>
            <td style="padding:38px 34px 30px;">
              ...
              <p style="margin:0 0 24px;font-size:16px;line-height:26px;color:#334155;">
                We’re confirming that the email address connected to your <strong>Dubai Job Zone</strong> account was changed. If you made this update, no action is needed.
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="margin:28px 0;">
                <tr>
                  <td style="background:#fff7ed;border:1px solid #fed7aa;border-radius:22px;padding:22px 20px;">
                    <p style="margin:0 0 14px;font-size:15px;line-height:23px;color:#9a3412;font-weight:900;">
                      Change details
                    </p>

                    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                      <tr>
                        <td style="padding:8px 0;font-size:14px;line-height:22px;color:#9a3412;width:150px;font-weight:800;vertical-align:top;">
                          Previous email:
                        </td>
                        <td style="padding:8px 0;font-size:14px;line-height:22px;color:#9a3412;word-break:break-all;">
                          ${safeOldEmail}
                        </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td style="padding:8px 0;font-size:14px;line-height:22px;color:#9a3412;">
                          ${safeChangedAt}
                        </td>
                      </tr>
                    </table>
                ...
                <tr>
                  <td style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:18px;padding:18px;">
                    ...
                    <p style="margin:0;font-size:14px;line-height:22px;color:#475569;">
                      You do not need to do anything else. Future Dubai Job Zone account and job notifications will be sent according to your updated account settings.
                    </p>
                  </td>
                </tr>
              </table>
                ...
                <tr>
                  <td style="background:#fef2f2;border:1px solid #fecaca;border-radius:18px;padding:17px 18px;">
                    ...
                    <p style="margin:0;font-size:14px;line-height:22px;color:#991b1b;">
                      Secure your account immediately and contact Dubai Job Zone support. Someone may have access to your account.
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="padding:24px 34px 34px;background:#ffffff;">
              ...
              <p style="margin:0 0 8px;font-size:12px;line-height:20px;color:#94a3b8;">
                This security email was sent because your account email address changed.
              </p>
