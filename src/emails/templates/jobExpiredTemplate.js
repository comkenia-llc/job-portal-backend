...
function jobExpiredTemplate({
    ...
    postNewJobUrl = "https://dubaijobzone.com/dashboard/employer/jobs/new",
    ...
    const safeExpiredAt = escapeHtml(formatDate(expiredAt));
    ...
    const safePostNewJobUrl = escapeHtml(postNewJobUrl);
    const safeSupportEmail = escapeHtml(supportEmail);
    const safeSiteUrl = escapeHtml(siteUrl);

    const subject = `Your job post has expired: ${jobTitle}`;

    const text = `
Hi ${employerName},

Your job post on Dubai Job Zone has expired.
...
Expired at: ${formatDate(expiredAt)}
...
<body style="margin:0;padding:0;background:#eef3f8;font-family:Arial,Helvetica,sans-serif;color:#0f172a;-webkit-font-smoothing:antialiased;">
  <div style="display:none;max-height:0;overflow:hidden;font-size:1px;line-height:1px;color:#eef3f8;opacity:0;">
    Your job post ${safeJobTitle} has expired on Dubai Job Zone.
  </div>
          ...
          <tr>
            <td style="background:linear-gradient(135deg,#0f172a 0%,#172554 48%,#075985 100%);padding:34px 34px 32px;">
              ...
              <div style="margin-top:8px;font-size:14px;line-height:22px;color:#c7d2fe;">
                Job expired • Employer listing update
              </div>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:38px 34px 30px;">
              ...
              <p style="margin:0 0 24px;font-size:16px;line-height:26px;color:#334155;">
                Your job post <strong>${safeJobTitle}</strong>${safeCompanyName ? ` for <strong>${safeCompanyName}</strong>` : ""} has expired on <strong>Dubai Job Zone</strong>. Candidates may no longer be able to apply unless you renew or update the listing.
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="margin:26px 0;">
                <tr>
                  <td style="background:#ffffff;border:1px solid #fed7aa;border-radius:22px;padding:20px;">
                    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                      <tr>
                        <td width="50%" style="padding:8px;vertical-align:top;">
                          <div style="background:#fff7ed;border:1px solid #fed7aa;border-radius:16px;padding:16px;">
                            <div style="font-size:12px;line-height:18px;color:#c2410c;font-weight:900;text-transform:uppercase;letter-spacing:0.8px;">
                              Status
                            </div>
            ...
            : ""
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                      <tr>
                        <td style="padding:6px 0;font-size:14px;line-height:22px;color:#475569;">
                          ✓ Renew or update the job if the position is still open.
                        </td>
                      </tr>
                      <tr>
                        <td style="padding:6px 0;font-size:14px;line-height:22px;color:#475569;">
                          ✓ Review existing applications before posting the role again.
                        </td>
                      </tr>
                      <tr>
                        <td style="padding:6px 0;font-size:14px;line-height:22px;color:#475569;">
                          ✓ Improve the title, salary, location, and description if you want better candidate response.
                        </td>
                      </tr>
                    </table>
                  </td>
              ...
              <table cellpadding="0" cellspacing="0" role="presentation" style="margin:0 0 28px;">
                <tr>
                  <td align="center" bgcolor="#f8fafc" style="border-radius:14px;border:1px solid #e2e8f0;">
                    <a href="${safePostNewJobUrl}" target="_blank" style="display:inline-block;padding:13px 22px;font-size:14px;font-weight:900;color:#2563eb;text-decoration:none;border-radius:14px;background:#f8fafc;">
                      Post a New Job
                    </a>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:18px;padding:17px 18px;">
                    ...
                    <p style="margin:0;font-size:14px;line-height:22px;color:#1e40af;">
                      If the role is still open, renewing quickly can help keep candidate interest fresh and reduce hiring delays.
                    </p>
                  </td>
                </tr>
              </table>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="max-width:680px;width:100%;">
          <tr>
            <td align="center" style="padding:18px 12px 0;">
              <p style="margin:0;font-size:12px;line-height:20px;color:#94a3b8;">
                Automated Dubai Job Zone job expiry notification.
              </p>
            </td>
          </tr>
        </table>
