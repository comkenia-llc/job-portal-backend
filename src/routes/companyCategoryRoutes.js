...
const controller = require("../controllers/companyCategoryController");
...
const setCompanyCategoriesFolder = (req, _res, next) => {
    req.uploadFolder = "company-categories";
    next();
};
