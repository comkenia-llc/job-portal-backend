...
exports.listCategories = async (req, res) => {
    try {
        ...
        if (parentId !== undefined) {
            // explicit parent filter; allow null for root categories
        ...
        console.error("❌ listJobCategories error", err);
...
exports.getCategory = async (req, res) => {
    try {
        ...
        res.status(500).json({ error: "Failed to fetch job category" });
    }
};
...
exports.createCategory = async (req, res) => {
    try {
        ...
        res.status(400).json({ error: err.message || "Failed to create job category" });
    }
};
...
exports.updateCategory = async (req, res) => {
    try {
        ...
        console.error("❌ updateJobCategory error", err);
        res.status(400).json({ error: err.message || "Failed to update job category" });
    }
};
...
exports.deleteCategory = async (req, res) => {
    try {
        ...
        console.error("❌ deleteJobCategory error", err);
